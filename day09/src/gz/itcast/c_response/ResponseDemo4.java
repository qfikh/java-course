...
//		response.getOutputStream().write("<html><head><title>this is tilte</title></head><body><h1>中国</h1><img src="+filepath+"><img></body></html>".getBytes("utf-8"));
//		response.getWriter().write("<html><head><title>this is tilte</title></head><body><h1>中国</h1><img src="+filepath+"><img></body></html>");
